...
export default function SidebarContainer({ children }: { children: React.ReactNode }) {
    ...
    return (
        <>
            ...
            <button
                className="hidden md:block self-start mt-6 ml-1 border border-foreground px-1 py-1 text-[10px] font-bold leading-none text-foreground hover:bg-foreground hover:text-background transition-colors"
